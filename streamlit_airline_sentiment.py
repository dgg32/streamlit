...
st.markdown("This application is a Streamkit dashboard to analyze the sentiment of tweets😀")
st.sidebar.markdown("This application is a Streamkit dashboard to analyze the sentiment of tweets😀")
...
choice = st.sidebar.multiselect("Pick airline", airlines, key=0)
...
word_sentiment = st.sidebar.radio("Display word cloud for what sentiment?",  unique_sentiments)
